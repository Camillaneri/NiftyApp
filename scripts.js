...
function getTask() {
    ...
    document.getElementById("changeMe").innerHTML = '       <div class="col-3 bg-dark text-light h-100" id="dashboard">                     <div class="position-absolute bg-dark p-3 container-fluid" id="DashHeader">                <span> Dashboard</span>                <button class="btn btn-dark expand" type="button"id="Expand" onclick="ExpandDash()">                    <i class="bi bi-arrows-angle-expand"></i>                </button><button class="btn btn-dark expand d-none" type="button" id="Contract" onclick="ContractDash()">                    <i class="bi bi-arrows-angle-contract"></i>                </button>            </div>                <div class="px-3 position-relative" id="imagesGrid">                                <div class="my-4 position-relative getDataboxDash border rounded border-light p-0" id="getDataDash" ondrop="dropcopy(event)" ondragover="allowDrop(event)"  >                                     <button class="btn btn-light position-absolute d-none ClearBtn" id="clearBtn"><i class="bi bi-x-lg"></i></button>                </div>                                     </div>                     <div class="container-fluid d-flex position-absolute px-3 bg-dark" id="dashFooter" >                <button class="mx-1 col btn btn-success w-50" type="button" onclick="getHome()">Next</button>                <button class="mx-1col btn btn-success w-50" type="button" onclick="resetDash()">Reset</button>            </div>        </div>        <div class="col p-4" id="galleryBack">            <div class="p-4 mb-2" id="TaskBox">                              <h4>Rank items by similarity</h4>                                <p class="lead">Given the reference image drag and drop in order of similarity (from 1 to 5)the images below</p>                  </div>            <div class="mb-2 " id="QueryForm">                              <div class="input-group">                                  <div class="px-2 col border-end" >                         <span class="row " >                            <i class="bi bi-hand-thumbs-up py-2">  Likes</i>                        </span>                        <div class="row mx-1" id="LikesBox">                                               </div>                    </div>                     <div class="px-2 col">                         <span class="row horizontal-scroll">                            <i class="bi bi-hand-thumbs-down py-2">  Dislikes</i>                        </span>                        <div class="row mx-1" id="DislikesBox">                                               </div>                    </div>                 </div>                <div class="row mx-1 py-2">                    <button class="mx-1 col btn btn-success w-100" type="button" onclick="sendQuery()">Apply</button>                                        <button class="mx-1 col btn btn-success w-100" type="button" onclick="resetQuery()">Reset</button>                </div>            </div>                 <div class="row mx-1" id="Gallery">                                                     <div class="position-relative col-3 p-0 GalleryItem">                        <div class="col-2 m-1 position-absolute">                            <button class="btn btn-light p-1 " id="LikeBtn" onclick="AddLiked(event)"><i class="bi bi-hand-thumbs-up"></i></button>                            <button class="btn btn-light p-1 " id="DislikeBtn"  onclick="AddDisliked(event)"><i class="bi bi-hand-thumbs-down"></i></button>                        </div>                        <img id="dragData3" src="https://ipfs.pixura.io/ipfs/QmW3XevHttaTBQ9CwVYtTE8e92kpmCJW4FysGncSfPDBee/screaminSkull-final-opt.gif" class="img-thumbnail" alt="..." draggable = “true” ondragstart="drag(event)">                    </div>                                 <div class="position-relative col-3 p-0 GalleryItem">                        <div class="col-2 m-1 position-absolute">                            <button class="btn btn-light p-1 " id="LikeBtn" onclick="AddLiked(event)"><i class="bi bi-hand-thumbs-up"></i></button>                            <button class="btn btn-light p-1 " id="DislikeBtn"  onclick="AddDisliked(event)"><i class="bi bi-hand-thumbs-down"></i></button>                        </div>                        <img id="dragData2" src="https://ipfs.pixura.io/ipfs/QmW3XevHttaTBQ9CwVYtTE8e92kpmCJW4FysGncSfPDBee/screaminSkull-final-opt.gif" class="img-thumbnail" alt="..." draggable = “true” ondragstart="drag(event)"></div>                                 <div class="position-relative col-3 p-0 GalleryItem">                        <div class="col-2 m-1 position-absolute">                            <button class="btn btn-light p-1 " id="LikeBtn" onclick="AddLiked(event)"><i class="bi bi-hand-thumbs-up"></i></button>                            <button class="btn btn-light p-1 " id="DislikeBtn"  onclick="AddDisliked(event)"><i class="bi bi-hand-thumbs-down"></i></button>                        </div>                        <img id="dragData1" src="https://ipfs.pixura.io/ipfs/QmW3XevHttaTBQ9CwVYtTE8e92kpmCJW4FysGncSfPDBee/screaminSkull-final-opt.gif" class="img-thumbnail" alt="..." draggable = “true” ondragstart="drag(event)"></div>                                 <div class="position-relative col-3 p-0 GalleryItem">                        <div class="col-2 m-1 position-absolute">                            <button class="btn btn-light p-1 " id="LikeBtn" onclick="AddLiked(event)"><i class="bi bi-hand-thumbs-up"></i></button>                            <button class="btn btn-light p-1 " id="DislikeBtn"  onclick="AddDisliked(event)"><i class="bi bi-hand-thumbs-down"></i></button>                        </div>                        <img id="dragData4" src="https://ipfs.pixura.io/ipfs/QmW3XevHttaTBQ9CwVYtTE8e92kpmCJW4FysGncSfPDBee/screaminSkull-final-opt.gif" class="img-thumbnail" alt="..." draggable = “true” ondragstart="drag(event)"></div>                                                        <div class="position-relative col-3 p-0 GalleryItem">                        <div class="col-2 m-1 position-absolute">                            <button class="btn btn-light p-1 " id="LikeBtn" onclick="AddLiked(event)"><i class="bi bi-hand-thumbs-up"></i></button>                            <button class="btn btn-light p-1 " id="DislikeBtn"  onclick="AddDisliked(event)"><i class="bi bi-hand-thumbs-down"></i></button>                        </div>                        <img id="dragData5" src="https://ipfs.pixura.io/ipfs/QmW3XevHttaTBQ9CwVYtTE8e92kpmCJW4FysGncSfPDBee/screaminSkull-final-opt.gif" class="img-thumbnail" alt="..." draggable = “true” ondragstart="drag(event)"></div>                                 <div class="position-relative col-3 p-0 GalleryItem">                        <div class="col-2 m-1 position-absolute">                            <button class="btn btn-light p-1 " id="LikeBtn" onclick="AddLiked(event)"><i class="bi bi-hand-thumbs-up"></i></button>                            <button class="btn btn-light p-1 " id="DislikeBtn"  onclick="AddDisliked(event)"><i class="bi bi-hand-thumbs-down"></i></button>                        </div>                        <img id="dragData6" src="https://ipfs.pixura.io/ipfs/QmW3XevHttaTBQ9CwVYtTE8e92kpmCJW4FysGncSfPDBee/screaminSkull-final-opt.gif" class="img-thumbnail" alt="..." draggable = “true” ondragstart="drag(event)"></div>                                 <div class="position-relative col-3 p-0 GalleryItem">                        <div class="col-2 m-1 position-absolute">                            <button class="btn btn-light p-1 " id="LikeBtn" onclick="AddLiked(event)"><i class="bi bi-hand-thumbs-up"></i></button>                            <button class="btn btn-light p-1 " id="DislikeBtn"  onclick="AddDisliked(event)"><i class="bi bi-hand-thumbs-down"></i></button>                        </div>                        <img id="dragData7" src="https://ipfs.pixura.io/ipfs/QmW3XevHttaTBQ9CwVYtTE8e92kpmCJW4FysGncSfPDBee/screaminSkull-final-opt.gif" class="img-thumbnail" alt="..." draggable = “true” ondragstart="drag(event)"></div>                                 <div class="position-relative col-3 p-0 GalleryItem">                        <div class="col-2 m-1 position-absolute">                            <button class="btn btn-light p-1 " id="LikeBtn" onclick="AddLiked(event)"><i class="bi bi-hand-thumbs-up"></i></button>                            <button class="btn btn-light p-1 " id="DislikeBtn"  onclick="AddDisliked(event)"><i class="bi bi-hand-thumbs-down"></i></button>                        </div>                        <img id="dragData8" src="https://ipfs.pixura.io/ipfs/QmW3XevHttaTBQ9CwVYtTE8e92kpmCJW4FysGncSfPDBee/screaminSkull-final-opt.gif" class="img-thumbnail" alt="..." draggable = “true” ondragstart="drag(event)"></div>                                                         <div class="position-relative col-3 p-0 GalleryItem">                        <div class="col-2 m-1 position-absolute">                            <button class="btn btn-light p-1 " id="LikeBtn" onclick="AddLiked(event)"><i class="bi bi-hand-thumbs-up"></i></button>                            <button class="btn btn-light p-1 " id="DislikeBtn"  onclick="AddDisliked(event)"><i class="bi bi-hand-thumbs-down"></i></button>                        </div>                        <img id="dragData9" src="https://ipfs.pixura.io/ipfs/QmW3XevHttaTBQ9CwVYtTE8e92kpmCJW4FysGncSfPDBee/screaminSkull-final-opt.gif" class="img-thumbnail" alt="..." draggable = “true” ondragstart="drag(event)"></div>                                 <div class="position-relative col-3 p-0 GalleryItem">                        <div class="col-2 m-1 position-absolute">                            <button class="btn btn-light p-1 " id="LikeBtn" onclick="AddLiked(event)"><i class="bi bi-hand-thumbs-up"></i></button>                            <button class="btn btn-light p-1 " id="DislikeBtn"  onclick="AddDisliked(event)"><i class="bi bi-hand-thumbs-down"></i></button>                        </div>                        <img id="dragData10" src="https://ipfs.pixura.io/ipfs/QmW3XevHttaTBQ9CwVYtTE8e92kpmCJW4FysGncSfPDBee/screaminSkull-final-opt.gif" class="img-thumbnail" alt="..." draggable = “true” ondragstart="drag(event)"></div>                                 <div class="position-relative col-3 p-0 GalleryItem">                        <div class="col-2 m-1 position-absolute">                            <button class="btn btn-light p-1 " id="LikeBtn" onclick="AddLiked(event)"><i class="bi bi-hand-thumbs-up"></i></button>                            <button class="btn btn-light p-1 " id="DislikeBtn"  onclick="AddDisliked(event)"><i class="bi bi-hand-thumbs-down"></i></button>                        </div>                        <img id="dragData11" src="https://ipfs.pixura.io/ipfs/QmW3XevHttaTBQ9CwVYtTE8e92kpmCJW4FysGncSfPDBee/screaminSkull-final-opt.gif" class="img-thumbnail" alt="..." draggable = “true” ondragstart="drag(event)"></div>                                 <div class="position-relative col-3 p-0 GalleryItem">                        <div class="col-2 m-1 position-absolute">                            <button class="btn btn-light p-1 " id="LikeBtn" onclick="AddLiked(event)"><i class="bi bi-hand-thumbs-up"></i></button>                            <button class="btn btn-light p-1 " id="DislikeBtn"  onclick="AddDisliked(event)"><i class="bi bi-hand-thumbs-down"></i></button>                        </div>                        <img id="dragData12" src="https://ipfs.pixura.io/ipfs/QmW3XevHttaTBQ9CwVYtTE8e92kpmCJW4FysGncSfPDBee/screaminSkull-final-opt.gif" class="img-thumbnail" alt="..." draggable = “true” ondragstart="drag(event)"></div>                                                          <div class="position-relative col-3 p-0 GalleryItem">                        <div class="col-2 m-1 position-absolute">                            <button class="btn btn-light p-1 " id="LikeBtn" onclick="AddLiked(event)"><i class="bi bi-hand-thumbs-up"></i></button>                            <button class="btn btn-light p-1 " id="DislikeBtn"  onclick="AddDisliked(event)"><i class="bi bi-hand-thumbs-down"></i></button>                        </div>                        <img id="dragData13" src="https://ipfs.pixura.io/ipfs/QmW3XevHttaTBQ9CwVYtTE8e92kpmCJW4FysGncSfPDBee/screaminSkull-final-opt.gif" class="img-thumbnail" alt="..." draggable = “true” ondragstart="drag(event)"></div>                                 <div class="position-relative col-3 p-0 GalleryItem">                        <div class="col-2 m-1 position-absolute">                            <button class="btn btn-light p-1 " id="LikeBtn" onclick="AddLiked(event)"><i class="bi bi-hand-thumbs-up"></i></button>                            <button class="btn btn-light p-1 " id="DislikeBtn"  onclick="AddDisliked(event)"><i class="bi bi-hand-thumbs-down"></i></button>                        </div>                        <img id="dragData14" src="https://ipfs.pixura.io/ipfs/QmW3XevHttaTBQ9CwVYtTE8e92kpmCJW4FysGncSfPDBee/screaminSkull-final-opt.gif" class="img-thumbnail" alt="..." draggable = “true” ondragstart="drag(event)"></div>                                 <div class="position-relative col-3 p-0 GalleryItem">                        <div class="col-2 m-1 position-absolute">                            <button class="btn btn-light p-1 " id="LikeBtn" onclick="AddLiked(event)"><i class="bi bi-hand-thumbs-up"></i></button>                            <button class="btn btn-light p-1 " id="DislikeBtn"  onclick="AddDisliked(event)"><i class="bi bi-hand-thumbs-down"></i></button>                        </div>                        <img id="dragData15" src="https://ipfs.pixura.io/ipfs/QmW3XevHttaTBQ9CwVYtTE8e92kpmCJW4FysGncSfPDBee/screaminSkull-final-opt.gif" class="img-thumbnail" alt="..." draggable = “true” ondragstart="drag(event)"></div>                                 <div class="position-relative col-3 p-0 GalleryItem">                        <div class="col-2 m-1 position-absolute">                            <button class="btn btn-light p-1 " id="LikeBtn" onclick="AddLiked(event)"><i class="bi bi-hand-thumbs-up"></i></button>                            <button class="btn btn-light p-1 " id="DislikeBtn"  onclick="AddDisliked(event)"><i class="bi bi-hand-thumbs-down"></i></button>                        </div>                        <img id="dragData16" src="https://ipfs.pixura.io/ipfs/QmW3XevHttaTBQ9CwVYtTE8e92kpmCJW4FysGncSfPDBee/screaminSkull-final-opt.gif" class="img-thumbnail" alt="..." draggable = “true” ondragstart="drag(event)"></div>                             </div>            </div>        </div>';};
